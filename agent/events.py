...
class AgentEvent:
    ...
    @classmethod
    def agent_error(cls, error: Exception, error_message: str, details: dict[str, Any] | None = None) -> AgentEvent:
        return cls(type=AgentEventType.AGENT_ERROR, data={"error": error_message, "details": details or {}})
